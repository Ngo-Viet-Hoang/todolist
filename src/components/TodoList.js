        ...
        <div className="container">
          <div id="to-do-app" className="to-do-list">
            ...
            <div className="tasker-container">
              <TaskList taskList={taskList} changeTaskStatus={this.changeTaskStatus} deleteTaskItem={this.deleteTaskItem} />
            </div>
            <div onClick={this.showAddNewTask} className="add-task-button">+</div>
            {
